data_type_list = set(["VALUE", "SERIAL", "BLANK", "FROM_TABLE", "NULL", "ZERO", "ONE", "RANDOM", "ZERO_PADDED", \
"RANDOM_ZERO_PADDED", "DECIMAL", "RANDOM_PRICE", "ENUM", "ID", "USERNAME", "PASSWORD", "NAME_FAMILY", "NAME_FIRST", \
