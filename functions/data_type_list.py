data_type_list = {"VALUE", "SERIAL", "BLANK", "FROM_TABLE", "NULL", "ZERO", "ONE", "RANDOM", "ZERO_PADDED", \
"RANDOM_ZERO_PADDED", "DECIMAL", "RANDOM_PRICE", "LIST_ORD", "LIST_RAND", "ENUM", "ID", "USERNAME", "PASSWORD", "NAME_FAMILY", "NAME_FIRST", \
...
"COMPANY_NAME", "COMPANY_ROLE", "COMPANY_DIVISION", "INDUSTRY", "TIMESTAMP_NOW", "TIMESTAMP_TODAY", "TIMESTAMP_DATE", \
